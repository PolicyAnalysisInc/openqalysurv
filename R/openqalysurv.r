...
#' @importFrom stats pweibull dweibull rweibull qweibull plnorm dlnorm rlnorm qlnorm as.formula model.matrix stepfun integrate uniroot runif
...
#' @importFrom stringr str_glue_data str_to_title str_replace str_sub
