...
The openqalysurv package provides functions for defining a wide variety of survival distributions of different types.
...
In addition to the functions provided by openqalysurv, you can use survival distributions created from supported third-party packages.
